  ...
  return (
    <div>
      <div id="carouselExampleInterval" className="carousel slide" data-bs-ride="carousel">
        ...
        <button className="carousel-control-prev" id='slidebut' type="button" data-bs-target="#carouselExampleInterval" data-bs-slide="prev">
          <span className="carousel-control-prev-icon" aria-hidden="true"></span>
          <span className="visually-hidden">Previous</span>
        </button>
        <button className="carousel-control-next" id='slidebut' type="button" data-bs-target="#carouselExampleInterval" data-bs-slide="next">
      ...
      <ul >
        {Array.isArray(recipes) ? (
          recipes.map((recipe) => (
            <li key={recipe._id} className="border">
              <div>
                <h2>{recipe.name}</h2>
                <img className="img" src={recipe.imageUrl} alt={recipe.name} /><br />
